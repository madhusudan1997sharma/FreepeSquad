...
public class InAppPurchasing : MonoBehaviour, IStoreListener
{
    ...
    private static string kProductIDConsumable = "minutes";                                                         // General handle for the consumable product.

    private static string kProductNameAppleConsumable = "com.scouterstudios.freepesquad";             // Apple App Store identifier for the consumable product.

    private static string kProductNameGooglePlayConsumable = "com.scouterstudios.freepesquad";        // Google Play Store identifier for the consumable product.

    private static string kProductNameWindowsConsumable = "com.scouterstudios.freepesquad";            // Windows Phone Store identifier for the consumable product.
    ...
    public void InitializePurchasing()
    {
        ...
        builder.AddProduct(kProductIDConsumable, ProductType.Consumable, new IDs() { { kProductNameAppleConsumable, AppleAppStore.Name }, { kProductNameGooglePlayConsumable, GooglePlay.Name }, {kProductNameWindowsConsumable, WindowsStore.Name}, });// Continue adding the non-consumable product.
    ...
    public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args)
    {
        ...
        if (String.Equals(args.purchasedProduct.definition.id, kProductIDConsumable, StringComparison.Ordinal))
        {
            ...
            //Script for adding Consumable items in account like adding coins.
            PlayerPrefs.SetInt("Minutes", PlayerPrefs.GetInt("Minutes") + 100);
        }
